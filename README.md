...
See [menu synchronization notes](MENU_SYNC.md) when changing the in-app navbar or macOS menu.

See [appearance settings notes](APPEARANCE_SETTINGS.md) when changing the search or submenus.
